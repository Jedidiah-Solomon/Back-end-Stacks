...
const products = [
    {
        ...
        dateAdded: new Date("2020-03-13T08:14:30Z"),
    },
    {
        _id: 1,
        name: "Cheese Pizza",
        ...
        stock: 200,
        supplier: "Best Pizza Co",
        dateAdded: new Date("2020-03-13T09:13:24Z"),
    },
    {
        _id: 2,
        name: "Vegan Pizza",
        ...
        dateAdded: new Date("2020-03-17T09:22:12Z"),
    },
    {
        _id: 3,
        name: "Soda",
        ...
        dateAdded: new Date("2020-01-13T11:21:39.736Z"),
    },
    {
        _id: 4,
        name: "Water",
        ...
        stock: 1000,
        supplier: "Cool Drinks",
        dateAdded: new Date("2020-01-12T21:23:13.331Z"),
    },
    {
        _id: 5,
        name: "Salad",
        ...
        stock: 300,
        supplier: "Healthy Eats",
        dateAdded: new Date("2021-01-12T05:08:13Z"),
    },
];

// Insert the data into the collections
db.getCollection(collection_1).insertMany(orders);
db.getCollection(collection_2).insertMany(customers);
db.getCollection(collection_3).insertMany(products);

console.log(`Inserted ${orders.length} documents into the orders collection`);
console.log(
    `Inserted ${customers.length} documents into the customers collection`
);
console.log(
    `Inserted ${products.length} documents into the products collection`
);
