...
// var salesOnApril4th = db.sales.find({
//   date: { $gte: new Date('2014-04-04'), $lt: new Date('2014-04-05') }
// }).count();

// print("Number of sales on April 4th, 2014: " + salesOnApril4th);

//Nested document
/*
{
    "_id": ObjectId("5f8a2b6e4e7d1a001fbbd4c3"),
    "author": "John Doe",
    "age": 22,
