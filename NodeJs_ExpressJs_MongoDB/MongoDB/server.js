...
mongoose
    .connect(process.env.MONGODB_URI_ADMIN, { serverSelectionTimeoutMS: 30000 }) // Increase timeout to 30 seconds
...
app.post("/login", async (req, res) => {
    ...
    try {
        ...
        // If both email and password are correct, login successful
